"""
REALM OF SHADOWS - MAIN APPLICATION V1 (LEGACY)
===============================================
This is the V1 main application file that combines:
...
For new development, use app/main.py (V2) which is FastAPI-only.
This file is maintained for Discord bot functionality.
"""
