...
class EnhancedReadinessButton(discord.ui.Button):
    ...
    async def _perform_enhanced_awakening(self):
        ...
        api_client = APIClient()
        user_data = await api_client.get_user_profile(self.view.user)  # Fixed method name
...
class EnhancedAwakeningButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        await run_with_animation(interaction, self._show_readiness_selection)
...
class ViewQuestsButton(discord.ui.Button):
    ...
    async def _show_quests(self):
        """Show quest details - placeholder implementation"""
        # This would need full implementation
        embed = discord.Embed(
            title="🚧 Quest View",
            description="Quest viewing functionality coming soon!",
            color=discord.Color.orange()
        )
        return embed
...
class ViewBriefingButton(discord.ui.Button):
    ...
    async def _show_briefing(self):
        """Show daily briefing - placeholder implementation"""
        # This would need full implementation
        embed = discord.Embed(
            title="🚧 Daily Briefing",
            description="Briefing functionality coming soon!",
            color=discord.Color.orange()
        )
        return embed
...
class ViewHistoryButton(discord.ui.Button):
    ...
    async def _show_history(self):
        """Show awakening history - placeholder implementation"""
        # This would need full implementation
        embed = discord.Embed(
            title="🚧 Awakening History",
