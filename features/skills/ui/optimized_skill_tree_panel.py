...
class SkillTreeView(discord.ui.View):
    """View for skill tree panel with category navigation and unlock buttons."""
...
# --- CATEGORY NAVIGATION BUTTONS (OPTIMIZED) ---
...
class UnlockSkillButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        # Show skill selection dropdown instead of auto-unlocking
        try:
            library_data = await get_cached_library_data(self.user)
